...
@section('meta_title')
    @if(!isset($inventories))
        Agregar material
    @else
        Material asignado al RIC {{$inventories->ric->Nric}}
    @endif
@endsection
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('material[description]',[null=>'---Selecionar---']+$materials->toArray(),old('material[description]'),[
                                        'class'=>'form-control','id'=>'material[description]', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('ric_id',[null=>'---Selecionar---']+$rics->toArray(),old('ric_id'),[
                                        'class'=>'form-control','id'=>'ric_id', 'disabled',
                                        'data-required-error' => 'Este campo es obligatorio',
                                    ]) !!}
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('quantity',old('quantity'),[
                            			...
                            			'required'=>'', 'autocomplete'=>'off', 'id' => 'quantity','disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[specification]',old('material[specification]'),[
                            			'class'=>'form-control','placeholder'=>'specification', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[thickness]',old('material[thickness]'),[
                            			'class'=>'form-control','placeholder'=>'thickness', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[dimension]',old('material[dimension]'),[
                            			'class'=>'form-control','placeholder'=>'dimension', 'disabled',
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[length]',old('material[length]'),[
                                        'class'=>'form-control','placeholder'=>'length', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[net_weight]',old('material[net_weight]'),[
                                        'class'=>'form-control','placeholder'=>'net_weight', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[gross_weight]',old('material[gross_weight]'),[
                            			'class'=>'form-control','placeholder'=>'gross_weight', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('material[trademark]',old('material[trademark]'),[
                            			'class'=>'form-control','placeholder'=>'trademark', 'disabled',
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::select('material[material_type_id]',[null=>'---Selecionar---']+$material_types->toArray(),old('material[material_type_id]'),[
                                        'class'=>'form-control','id'=>'material[material_type_id]', 'disabled',
                                        'data-required-error' => 'Este campo es obligatorio',
                                    ]) !!}
                                    <div class="help-block with-errors"></div>
                                </div>
